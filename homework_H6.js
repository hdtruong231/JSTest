 ...
 const events = [
    ...
    function checkDateValid(daystring) // type DD-MM-YYYY
    {
        let a = daystring.split("-");
        let day = parseInt(a[0]);
    ...
    {
        if (checkDateValid(daystring) == false) return console.log("Invalid date");
        let a = daystring.split("-");
        ...
        console.log("Event in day", daystring,":");
        let check = false;
        for ( let x of events)
        {
    ...
    function showTimes(daystring) //type. DD-MM-YYYY
    {
        ...
        {
            let check = false;
            console.log("Events that will happen betwen now and", daystring,":");
            for (let x of events)
            {
        ...
        {
            let check = false;
            console.log("Events that have happened since", daystring,":");
            for (let x of events)
            {
                if (x.date < now && x.date > date)
                {
    ...
    // showEvents("1-12-2023");
     ...
     showEvents("31-2-2022");
     showEvents("20-12-2023");
     showTimes("1-111-2024");
     showTimes("1-11-2026");